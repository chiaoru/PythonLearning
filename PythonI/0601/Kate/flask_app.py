...
def handle_message(event):
    ...
    if msgtype == 1:
        ...
        message = StickerSendMessage(package_id=8515, sticker_id=16581242)

    elif msgtype == 4:
        message = LocationSendMessage(title='我在哪裡', address='台中一中', latitude=24.1501454, longitude=120.6847011)        
