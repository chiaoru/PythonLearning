# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 19:06:07 2023
...
for item in allli:
    ...
    teacher = item.find('div', class_='courseListDate').text
    room = item.find('div', class_='courseListRoom').text
...
url2 = "https://member.lccnet.com.tw/TimeLine"
